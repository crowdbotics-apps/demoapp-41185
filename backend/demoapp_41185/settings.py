"""
Django settings for demoapp_41185 project.
...
ROOT_URLCONF = 'demoapp_41185.urls'
...
WSGI_APPLICATION = 'demoapp_41185.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp_41185 API",
    "DESCRIPTION": "API documentation for demoapp_41185 App",
    "VERSION": "v1",
}
